<?php
/**
 * Template for displaying single resources.
 *
 * @package rent-fetch-theme
 */
	...
	while ( have_posts() ) :
		...
		<div class="resources-container">
				...
				<div class="resources-sidebar-content">
					<?php
						...
						function display_terms_hierarchy($terms, $current_post_id, $deepest_term_id, $level = 0) {
							...
							foreach ($terms as $term) {
								$post_terms = wp_get_post_terms($current_post_id, 'resourcetypes', array('fields' => 'ids'));
								$all_current_terms = $post_terms;
								foreach ($post_terms as $term_id) {
									$ancestors = get_ancestors($term_id, 'resourcetypes');
						...
						$terms = get_terms_hierarchical('resourcetypes');
						
						// Find the deepest term for the current post to highlight only there
						$current_post_terms = wp_get_post_terms(get_the_ID(), 'resourcetypes', array('fields' => 'ids'));
			...
			<div class="resources-main">
				<?php
				// Breadcrumbs
				$post_terms = wp_get_post_terms( get_the_ID(), 'resourcetypes' );
			...
			<div class="resources-toc" id="resources-toc">
				<div class="resources-toc-content">
					<form role="search" class="resources-search-form">
						<input type="search" placeholder="Search resources..." class="resources-search-input" readonly />
					</form>
					<div class="resources-toc-list">
		...
		<!-- Search Modal -->
		<div id="resources-search-modal" class="resources-search-modal">
			<div class="resources-search-modal-content">
				<input type="search" id="resources-modal-search" placeholder="Search resources..." class="resources-search-modal-input" />
				<div class="resources-search-suggestions-modal" style="display: none;"></div>
			</div>
		</div>
